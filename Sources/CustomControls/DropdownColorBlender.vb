...
Public Class DropdownColorBlender
    ...
    Private _context As ITypeDescriptorContext = Nothing
    ...
    'List of Known Colors - Done this way to get the Known Colors in color shade order
    ...
    Public Sub New(ByVal editorService As IWindowsFormsEditorService, ByVal context As ITypeDescriptorContext)
        InitializeComponent()
...
#Region "Drawing"
    ...
    Private Sub BuildABlend()
        ...
        If _context.PropertyDescriptor.DisplayName = "ColorFillBlend" Then
            TheSample.ColorFillBlend = New cBlendItems(BlendColors, BlendPositions)
        Else
            TheSample.ColorFillBlendChecked = New cBlendItems(BlendColors, BlendPositions)
        End If
    End Sub
...
#Region "Painting"
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If TheSample.FillType = MyButton.eFillType.GradientPath Then
            TheSample.Refresh()
        End If
